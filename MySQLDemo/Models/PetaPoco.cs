...
namespace PetaPoco
{
	...
	public class Database : IDisposable
	{
        ...
        #region 存储过程调用 返回DataTable  DateSet

        /// <summary>
        /// 兼容Sqlhelper习惯 可以用 GetDataSet 代替
        /// </summary>
        /// <param name="proName"></param>
        /// <param name="OPS"></param>
        /// <returns></returns>
        public DataTable GetDataTableByPro(string proName, System.Data.SqlClient.SqlParameter[] OPS)
        {
            ...
            using (System.Data.SqlClient.SqlConnection conn = new System.Data.SqlClient.SqlConnection(_connectionString))
            {
                ...
                try
                {
                    ...
                    if (OPS != null)
                    {
                        foreach (System.Data.SqlClient.SqlParameter OP in OPS)
                        {
                            cmd.Parameters.Add(((ICloneable)OP).Clone());
                        }
                    }
                    System.Data.SqlClient.SqlDataAdapter oda = new System.Data.SqlClient.SqlDataAdapter(cmd);
                    oda.Fill(data);
                }
                catch (Exception ex)
                {
        ...
        /// <param name="OPS"></param>
        /// <returns></returns>
        public DataTable GetDataTableByPro(string proName, MySql.Data.MySqlClient.MySqlParameter[] OPS)
        {
            DataTable data = new DataTable();
            using (MySql.Data.MySqlClient.MySqlConnection conn = new  MySql.Data.MySqlClient.MySqlConnection(_connectionString))
            {
                ...
                try
                {
                    ...
                    if (OPS != null)
                    {
                        foreach (MySql.Data.MySqlClient.MySqlParameter OP in OPS)
                        {
                            cmd.Parameters.Add(((ICloneable)OP).Clone());
                        }
                    }
                    MySql.Data.MySqlClient.MySqlDataAdapter oda = new MySql.Data.MySqlClient.MySqlDataAdapter(cmd);
                    oda.Fill(data);
                }
                catch (Exception ex)
                {
        ...
        /// <summary>
        /// 兼容Sqlhelper习惯 可以用 GetDataTable 代替
        /// </summary>
        /// <param name="proName"></param>
        /// <param name="OPS"></param>
        /// <returns></returns>
        public DataSet GetDataSetByPro(string proName, MySql.Data.MySqlClient.MySqlParameter[] OPS)
        {
        ...
        /// <param name="sql">sql语句可以是存储过程 调用方法如下：";exec proc_City_search1 @0" 如果有输出参数则变为";exec proc_City_search1 @0 output"</param>
        ...
        /// <param name="sql">Sql语句，可以是存储过程 调用方法如下：";exec proc_City_search1 @0" 如果有输出参数则变为";exec proc_City_search1 @0 output"</param>
        /// <param name="args">参数</param>
